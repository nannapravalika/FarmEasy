...
from .email_settings import SET_EMAIL_USE_TLS, SET_EMAIL_HOST, SET_EMAIL_HOST_USER, \
...
SECRET_KEY = 'django-insecure-^oe!it6s-xnaj8yr4@*nrir!$39qh*_3&tcxjkv5gpugkr4iu%'
